"""
Servicio del módulo CSV (subida, validación y almacenamiento de archivos).
"""
import csv
import io
import json
...
class FileService:
    """Servicio para operaciones de archivos CSV."""
    ...
    def upload_and_process_csv(
        ...
        try:
            ...
            final_status = (
                "completed"
                if all(v.get("severity") != "error" for v in validations)
            ...
            raise ExternalServiceError(
                f"Error al procesar archivo: {str(e)}", service="procesamiento"
            )
