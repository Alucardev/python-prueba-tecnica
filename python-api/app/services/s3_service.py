"""
Servicio de AWS S3.
Maneja la subida y gestión de archivos en Amazon S3.
"""
import boto3
...
class S3Service:
    ...
    def upload_file(
        ...
        try:
            ...
            error_message = str(e)
            raise ExternalServiceError(f"Error al subir archivo: {error_message}", service="AWS S3")
        except Exception as e:
            raise ExternalServiceError(f"Error inesperado al subir archivo: {str(e)}", service="AWS S3")
